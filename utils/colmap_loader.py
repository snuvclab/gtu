...
def load_colmap_cameras(colmap_cam_path):
    ...
    if cameras_extrinsic_file.exists():
        cam_extrinsics = read_extrinsics_text(cameras_extrinsic_file)
    else:
        cam_extrinsics = read_extrinsics_binary((colmap_cam_path / "images.bin"))
    if cameras_intrinsic_file.exists():
        cam_intrinsics = read_intrinsics_text(cameras_intrinsic_file)
    else:
        cam_intrinsics = read_intrinsics_binary((colmap_cam_path / "cameras.bin"))
